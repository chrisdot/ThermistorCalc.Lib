...
namespace ThermistorCalcTest
{
	class Program
	{
		...
		{
			SteinhartHartModelCalculator stHCalc = SteinhartHartModelCalculator.CreateFrom3Values(-35, 112800, -5, 19800, 35, 3100);
			BetaModelCalculator betaCalc = BetaModelCalculator.CreateFrom3Values(-35, 112800, 35, 3100);
